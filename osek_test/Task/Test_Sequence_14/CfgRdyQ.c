...
static TaskType g_RdyQueueOfPriority5[3];
static TaskType g_RdyQueueOfPriority6[3];
static TaskType g_RdyQueueOfPriority7[3];
static TaskType g_RdyQueueOfPriority8[3];
static TaskType g_RdyQueueOfPriority9[3];
static TaskType g_RdyQueueOfPriority10[3];
static TaskType g_RdyQueueOfPriority11[3];
static TaskType g_RdyQueueOfPriority12[3];
static TaskType g_RdyQueueOfPriority13[3];
static TaskType g_RdyQueueOfPriority14[3];
static TaskType g_RdyQueueOfPriority15[3];
static TaskType g_RdyQueueOfPriority16[3];
